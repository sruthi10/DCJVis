...
public class PlotBuilderGCSkew extends PlotBuilderSymbols
{
	public PlotBuilderGCSkew()
	{
		super();
	}
	
	public PlotBuilderGCSkew(int windowSize, int stepSize)
	{
		super(windowSize,stepSize);
	}
	
	protected PlotBuilderGCSkew(PlotBuilderGCSkew other)
	{
	    super(other);
	}
	...
	public Shape[][] createPlot(GenomeData genomeData, SlotPath path, PlotDrawer plotDrawer)
	{
		...
		ProgressHandler.setMessage(ProgressHandler.CALCULATING_GC_SKEW_STRING + "...");
		
		if (windowSize > 0 && stepSize > 0)
		{
			calculator = new SkewCalculator.GC(genomeData, stepSize, windowSize);
		}
		else
		{
			calculator = new SkewCalculator.GC(genomeData);
		}
   ...
   @Override
    public boolean equals(Object o)
    {
        if (o == null)
            ...
            return true;
        else if (super.equals(o) && o.getClass() == PlotBuilderGCSkew.class)
            return true;
        return false;
    }
   ...
   public boolean similar(PlotBuilder o)
   {
       if (o == null)
           ...
           return true;
       else if (super.similar(o) && o.getClass() == PlotBuilderGCSkew.class)
           return true;
       return false;
   }
   ...
   {
       return new PlotBuilderGCSkew(this);
   }
}
