...
public class AnnotationValueEqualsPanel extends JPanel
{
	 ...
	 * Create the panel.
	 */
	public AnnotationValueEqualsPanel(GenomeDataController controller)
	{
		setBorder(new TitledBorder(null, "Annotation Value Equals", TitledBorder.LEADING, TitledBorder.ABOVE_TOP, null, null));
