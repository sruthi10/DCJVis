 ...
 *
 */
public class NewBlankStyleAction extends NewStyleAction
{
	public NewBlankStyleAction(GUIController guiController)
	{		
		super(guiController);
	}
	...
	{
		return StyleFactory.createNewBlankStyle(genomeData);
	}
}
