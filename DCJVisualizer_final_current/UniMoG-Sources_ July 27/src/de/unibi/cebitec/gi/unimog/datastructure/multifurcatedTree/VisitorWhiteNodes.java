 ...
 * @author -Rolf Hilker-
 * 
 * Visitor checking if there is a white node below the current node.
 */
public class VisitorWhiteNodes implements NodeVisitor {
	...
	/**
	 * Returns if there is a white node below the current node.
	 * @return true if there is a white node, fals otherwise
	 */
