...
public class Stack {
	...
	private int top = Stack.EMPTY_INDEX;

	/**
	 * Constructor for a new Stack object. The capacity must be given.
	...
	public Object pop() {
		if (this.isEmpty()) {
			return Stack.EMPTY_INDEX; // or some error message?
		} else {
